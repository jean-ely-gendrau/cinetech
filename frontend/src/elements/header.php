  ...
  <header>
    <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
      <div class="flex items-center flex-shrink-0 text-white mr-6">
        ...
        <span class="font-semibold text-xl tracking-tight">CineTech +</span>
      </div>
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow">
          <a href="/" class="text-base md:text-lg xl:texte-xl block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
            Accueil Cinetech
          </a>
          <a href="/film" class="text-base md:text-lg xl:texte-xl block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
            films
          </a>
          <a href="/serie" class="text-base md:text-lg xl:texte-xl block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
            séries
          </a>
          <a href="/contact" class="text-base md:text-lg xl:texte-xl block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
            contact
          </a>
        </div>
        <div>
