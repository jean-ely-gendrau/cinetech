...
$urlCanonical = $protocol . $hostName;
$pathJs = $urlCanonical . "/assets/js";
?>

<footer id="footer-cinetech" class="p-4 bg-white sm:p-6 dark:bg-gray-800">
  <div class="mx-auto max-w-screen-xl">
    <div class="md:flex md:justify-between">
      <div class="mb-6 md:mb-0">
        <span>
          <p class="sr-only">Lien vers l'acceuil CineTech</p>
          <a href="<?= $urlCanonical; ?>/" title="Acceuil Cinetech"><span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CineTech +</span></a>
        </span>
      </div>
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          ...
          <ul class="text-gray-600 dark:text-gray-400">
            <li class="mb-4">
              <a href="<?= $urlCanonical; ?>/greats" class="hover:underline">https://www.themoviedb.org</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="text-gray-600 dark:text-gray-400">
            <li class="mb-4">
              <a href="https://github.com/jean-ely-gendrau" class="hover:underline ">Github</a>
            </li>
            <li>
...
<!-- Add Script -->
<script src="<?= $pathJs; ?>/flowbite.min.js"></script>
